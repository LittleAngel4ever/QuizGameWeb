...
export let arrayQuiz = [
    ...
    {
        question: 'Какая команда использует двигатель Mercedes?',
        answerText: ["Red Bull Racing", "McLaren", "Alpine", "Ferrari"],
        correct: 1,
    },    
    {
        question: 'Сколько гонок обычно проводится в сезоне Формулы 1?',
    ...
    {
        question: 'Какой гонщик имеет наибольшее количество побед в истории Формулы 1?',
